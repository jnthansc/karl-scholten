...
const Datenschutz = () => {
    return (
        <div className="datenschutz">
            <div className="datenschutz-container">
                <h1 className="headingInformationPrivacy">Datenschutzerklärung</h1>
                ...
                <p>Karl Scholten<br />Zieblandstraße 32<br />80798 München, Deutschland</p>
                <p>E-Mail-Adresse: <a href="mailto:karl-scholten@gmx.de">karl-scholten@gmx.de</a></p>
                ...
                Vorgaben im Art. 21 DSGVO einlegen (weitere Hinweise zum Widerspruch erfolgen im Rahmen dieser
    ...
    Anfragen und Pflege von Nutzer- bzw. Geschäftsbeziehungen.</p>
        ...
        Telefonnummern); Inhaltsdaten (z.B. Eingaben in Onlineformularen).</li>
                    ...
                    <li><strong>Zwecke der Verarbeitung:</strong> Kontaktanfragen und Kommunikation; Erbringung vertraglicher Leistungen
        und Kundenservice.</li>
        ...
        mitgeteilten Anliegens. Zu diesem Zweck verarbeiten wir personenbezogene Daten im Rahmen vorvertraglicher und
        vertraglicher Geschäftsbeziehungen, soweit dies zu deren Erfüllung erforderlich ist und im Übrigen auf Grundlage
        unserer berechtigten Interessen sowie der Interessen der Kommunikationspartner an der Beantwortung der Anliegen
        und unserer gesetzlichen Aufbewahrungspflichten.</li>
                </ul>
    ...
    benötigen, dann können Sie sich an uns wenden.</p>
        ...
        Road, Menlo Park, CA, 94025, USA; <strong>Website:</strong> <a href="https://www.instagram.com"
                        >https://www.instagram.com</a>; <strong>Datenschutzerklärung:</strong> <a
                            href="https://instagram.com/about/legal/privacy"
                        >https://instagram.com/about/legal/privacy</a>.</li>
        ...
        Company, Wilton Place, Dublin 2, Irland; <strong>Website:</strong> <a href="https://www.linkedin.com"
                        >https://www.linkedin.com</a>; <strong>Datenschutzerklärung:</strong> <a
                            href="https://www.linkedin.com/legal/privacy-policy"
                        >https://www.linkedin.com/legal/privacy-policy</a>;
        <strong>Auftragsverarbeitungsvertrag:</strong> <a href="https://legal.linkedin.com/dpa"
                        >https://legal.linkedin.com/dpa</a>; <strong>Standardvertragsklauseln (Gewährleistung
            Datenschutzniveau bei Verarbeitung in Drittländern):</strong> <a href="https://legal.linkedin.com/dpa"
                        >https://legal.linkedin.com/dpa</a>; <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> <a
        ...
        Parkway, Mountain View, CA 94043, USA; <strong>Datenschutzerklärung:</strong> <a
    ...
    Verwendung von Cookies in dieser Datenschutzerklärung hinweisen.</p>
        ...
        DSGVO).</li>
                ...
                <p><strong>Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</strong></p>
                <ul class="m-elements">
                    <li><strong>Google Fonts: </strong>Bezug von Schriftarten ("Google Fonts") vom Anbieter Google zum Zwecke einer
        ...
        Betriebssystem, verwendete Hardware) übermittelt, die für die Bereitstellung der Schriftarten in Abhängigkeit
        von den verwendeten Geräten und der technischen Umgebung erforderlich sind. ; <strong>Dienstanbieter:</strong>
        ...
        Amphitheatre Parkway, Mountain View, CA 94043, USA; <strong>Website:</strong> <a
                            href="https://fonts.google.com/" >https://fonts.google.com/</a>;
        ...
        CA 94043, USA; <strong>Website:</strong> <a href="https://www.youtube.com"
                        >https://www.youtube.com</a>; <strong>Datenschutzerklärung:</strong> <a
                            href="https://policies.google.com/privacy" >https://policies.google.com/privacy</a>;
        <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Opt-Out-Plugin: <a
                            href="https://tools.google.com/dlpage/gaoptout?hl=de"
                        >https://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von
        Werbeeinblendungen: <a href="https://adssettings.google.com/authenticated"
                        >https://adssettings.google.com/authenticated</a>.</li>
                    <li><strong>Vimeo: </strong>Videoinhalte; <strong>Dienstanbieter:</strong> Vimeo Inc., Attention: Legal Department,
        555 West 18th Street New York, New York 10011, USA; <strong>Website:</strong> <a href="https://vimeo.com"
                        >https://vimeo.com</a>; <strong>Datenschutzerklärung:</strong> <a
                            href="https://vimeo.com/privacy">https://vimeo.com/privacy</a>;
        <strong>Widerspruchsmöglichkeit (Opt-Out):</strong> Wir weisen darauf hin, dass Vimeo Google Analytics einsetzen
        kann und verweisen hierzu auf die Datenschutzerklärung (<a href="https://policies.google.com/privacy"
                        >https://policies.google.com/privacy</a>) sowie die Opt-Out-Möglichkeiten für
        Google-Analytics (<a href="https://tools.google.com/dlpage/gaoptout?hl=de"
                        >https://tools.google.com/dlpage/gaoptout?hl=de</a>) oder die Einstellungen von Google für
        die Datennutzung zu Marketingzwecken (<a href="https://adssettings.google.com/"
                        >https://adssettings.google.com/</a>).</li>
                </ul>
        ...
        Übermitteln oder das Löschen. </li>
                ...
                <p class="seal"><a href="https://datenschutz-generator.de/"
                    ...
                    rel="noopener noreferrer nofollow"><img
                        ...
                        alt="Rechtstext von Dr. Schwenke - für weitere Informationen bitte anklicken." width="250" height="250" /></a>
                </p>
            </div>
        </div>
